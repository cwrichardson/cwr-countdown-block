...
window.addEventListener('DOMContentLoaded', () => {
  const placeholders = document.getElementsByClassName('cwr-countdown-block-placeholder');

  for (const placeholder of placeholders) {
    const data = JSON.parse(placeholder.querySelector('pre').innerText);
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(CountDown, data), placeholder);
  }
});
function CountDown(data) {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cwr-countdown"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_countdown__WEBPACK_IMPORTED_MODULE_1__["default"], {
    date: data.expire_time
  }));
}
...
function Edit(_ref) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!('expire_date' in attributes) || 'string' !== date.expire_date && !(date.expire_date instanceof String)) {
      setDate(new Date());
    } else {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, {
    ...
    id: "cwr-countdown-timer-controls"
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Expire Date and Time', 'cwr-countdown-timer')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.DateTimePicker, {
    currentDate: date,
    onChange: onChangeDateTime
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_countdown__WEBPACK_IMPORTED_MODULE_4__.CountDown, attributes));
}
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('create-block/cwr-countdown-block', {
  /**
   * Used to construct a preview for the block to be shown in the block
   * inserter.
   */
  example: {
    attributes: {
      message: 'Countdown Block'
    }
  },
 ...
 *
 * @return {null} - the block is dynamic, so save returns `null`.
 */
function save() {
  return null;
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcwr_countdown_block"] = self["webpackChunkcwr_countdown_block"] || [];
